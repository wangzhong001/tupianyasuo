...
//        mContext.startActivity(Intent.createChooser(mEmailIntent,mContext.getResources().getString(R.string.feedback)));
    ...
    public static void shareAudio(Context context, String uri) {
...
//        Uri uri = Uri.parse(audioUri.toString() + "/" + id);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {   //如果在Android7.0以上,使用FileProvider获取Uri
            ...
            KLog.e("file--->",file);
            Uri contentUri = FileProvider.getUriForFile(context, AppUtils.getPackageName(context), file);
            KLog.e("file--->",contentUri+"--->");
