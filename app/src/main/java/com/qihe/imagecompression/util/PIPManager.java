...
//    };
    ...
    private PIPManager() {
        ijkVideoView = new ListIjkVideoView(AdApplcation.getContext());
//        ijkVideoView.setVideoListener(mMyVideoListener);
//        mKeyReceiver = new KeyReceiver();
        mFloatController = new FloatController(AdApplcation.getContext());
//        IntentFilter homeFilter = new IntentFilter(Intent.ACTION_CLOSE_SYSTEM_DIALOGS);
//        MyApplication.getInstance().registerReceiver(mKeyReceiver, homeFilter);
        floatView = new FloatView(AdApplcation.getContext(), 0, 0);
    }
    ...
    public ListIjkVideoView getIjkVideoView() {
        return ijkVideoView;
    }
