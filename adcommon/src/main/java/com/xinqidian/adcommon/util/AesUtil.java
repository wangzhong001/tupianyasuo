...
public class AesUtil {
    ...
    public static final String CREATE_KEY="Q0M0Rjc5MDQ55555";
...
//          byte[] byteMi=  str2ByteArray(content);
    ...
    public static void main(String[] args) {
        String s = "15171418960";

        System.out.println("s:" + s);

        String s1 = AesUtil.aesEncrypt( s,"hcwt888888888888");
        System.out.println("s1:" + s1);

        System.out.println("s2:"+AesUtil.aesDecrypt(s1, "hcwt888888888888"));
