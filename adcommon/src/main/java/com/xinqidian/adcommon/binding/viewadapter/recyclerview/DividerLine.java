...
public class DividerLine extends RecyclerView.ItemDecoration {
     ...
     * 分隔线绘制模式,水平，垂直，两者都绘制
     */
    public final static int VERTICAL=100;
    public final static int HORIZONTAL=101;
    public final static int BOTH=102;
...
//    }
    ...
    public DividerLine(Context context, int mode) {
        this(context);
        this.mode = mode;
    }

    public DividerLine(Context context, int dividerSize, int mode) {
        this(context, mode);
