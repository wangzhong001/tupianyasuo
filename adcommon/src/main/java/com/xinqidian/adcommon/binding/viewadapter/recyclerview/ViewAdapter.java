...
public class ViewAdapter {
    ...
    @BindingAdapter(value = {"isNestedScrollingEnabled"}, requireAll = false)
    public static void setNestedScrollingEnabled(RecyclerView recyclerView,boolean isNestedScrollingEnabled) {
