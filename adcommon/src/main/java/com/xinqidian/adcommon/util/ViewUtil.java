...
public class ViewUtil {
    ...
    public static float px2dp(float px) {
        DisplayMetrics displayMetrics = Common.getApplication().getResources().getDisplayMetrics();
    ...
    public static int getDeviceWidthInPx() {
        Display display = ((WindowManager) Common.getApplication().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
